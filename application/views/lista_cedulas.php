    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li class="active">Lista Cedulas</li>
            </ol>
        </div>
    </div><p></p>
</div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-success">
                        <div class="panel-heading">Cedulas Actuales</div>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered">
                                            ...
                                            if($users ==false){}
                                                ...
                                                foreach ($users as $row) 
                                                {
                                                    ...
                                                    $aplicacion= $ci->aplication_model->get_aplication($row->id_aplicacion);
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?=$row2->Número_Proyecto?></td>
                                                    <td><?=$row2->Descripcion?></td>
                                                    <td><?=$row2->fecha_programada?></td>
                                                    <td> 
                                                        <?php echo form_open("Cedula/generar_pdf/".$row->id);?>
