    ...
    <section>
        ...
        <div class="container-fluid container-padded">
            <div class="row">
                <div class="col-md-12 page-title">
                    <h3>Programas de Fertilización</h3>
                    <hr>
                </div> <!-- col end -->
            </div> <!-- row end -->
        </div>
        ...
        <div class="container-fluid container-padded">
            <div class="row">
                                    ...
                                    <div class="form-inline">
                                       ...
                                       /*if ($idproyecto!=-1){
                                        ...
                                        ?>
                                            ...
                                            <input type="button" id="agregarProyecto" class="btn btn-sm btn-success" value="Buscar" />
                                        <?php
                                        //}
                                        ?>
                                    </div>
                ...
                <div class="col-md-12" style="display:none" id="listaTratamientosParaPrograma">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:center">
                                                        <a href="<?=base_url()?>">Generar Programa</a>
                                                    </td>
                                                </tr>
